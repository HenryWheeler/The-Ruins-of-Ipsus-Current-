    ...
    public class Poison : OnTurn
    {
        ...
        public override void Turn()
        {
            timeLeft--; if (timeLeft == 0)
            {
                ...
                { Log.Add("The Green*poison ailing " + entity.GetComponent<PronounSet>().subjective + " has subsided."); }
            }
            else
            {
                ...
                { Log.Add("The Green*poison drains " + dmg + " points of " + entity.GetComponent<PronounSet>().possesive + " health away."); }
            }
        }
